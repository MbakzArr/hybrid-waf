...
\begin{tikzpicture}[
  ...
  box/.style={draw, rounded corners, minimum width=2.3cm, minimum height=1cm,
              align=center, font=\small},
  arr/.style={-{Latex[length=2mm]}, thick}
]
\node[box] (m1) {M1\\TrafficReader};
\node[box, right=of m1] (m2) {M2\\FeatureExtractor};
\node[box, above right=8mm and 14mm of m2] (m3) {M3\\RuleEngine};
\node[box, below right=8mm and 14mm of m2] (m4) {M4\\MLClassifier};
...
\node[fit=(m3)(m4)(m5), inner sep=6mm, draw, dashed, rounded corners] (modebox) {};
\end{scope}
\node[above=1mm of modebox, font=\scriptsize] {hybrid mode consults both M3 and M4};
\end{tikzpicture}%
}
